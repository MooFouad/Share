...
const Checkout = () => {
    ...
    const [PaymentMethod, setPaymentMethod] = useState(process.env.REACT_APP_STRIPE_PAYMENT_METHOD ?? 6);
                            ...
                            <div className="col-lg-7 col-md-7">
                                <div className="order-details">
                                    ...
                                    <>
                                        ...
                                        type='submit' className='btn bg-success bold' id="lbl_check_placeorder">
                                            {LocalizationLabelsArray.length > 0 ?
