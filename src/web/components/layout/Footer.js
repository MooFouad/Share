                    ...
                    <div className="row">
                        <div className="col-lg-3 col-md-6">
                            <div className="single-footer-widget">
                                ...
                                <p>اكتشف عالمًا من الإمكانيات مع SafQa، وجهتك النهائية للتسوق عبر الإنترنت! اكتشف مجموعة متنوعة من المنتجات عالية الجودة والمصممة خصيصًا لتلبية جميع احتياجاتك. من أحدث الأدوات إلى الملابس الأنيقة والمستلزمات المنزلية الفريدة، تعد SafQa بتجربة تسوق سلسة وبأسعار لا تقبل المنافسة. تسوق بذكاء، تسوق صفقا!
</p>
                            </div>
                        </div>
                            ...
                            <div className="single-footer-widget">
                                ...
                                <ul className="footer-contact-info">
                                    ...
                                    <li>
                                        ...
                                        </span> <Link to="tel:(+20) 155-467-9637">(+20) 01554679637</Link>
                                    </li>
                                    <li>
